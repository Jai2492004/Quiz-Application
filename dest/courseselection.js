...
const courseTitle1 = JSON.parse(courseTitle);
courseTitle1.forEach((items, index) => {
    ...
    (_a = document.getElementById("showtitle")) === null || _a === void 0 ? void 0 : _a.appendChild(maindiv);
});
//recently viewed
const titleuser = localStorage.getItem(`${username1}`);
const titleuser1 = JSON.parse(titleuser);
...
if (titleuser1 !== null) {
    ...
    data3.forEach(title => {
        ...
        maindiv.appendChild(maintext);
        maindiv.appendChild(mainbutton);
        (_a = document.getElementById("recentview")) === null || _a === void 0 ? void 0 : _a.appendChild(maindiv);
    });
}
var titlearray = [];
