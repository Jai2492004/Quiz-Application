...
const titl1 = JSON.parse(titl);
titl1.forEach(items => {
    var _a;
    const option = document.createElement("option");
    option.textContent = items.title1;
    (_a = document.getElementById("courses")) === null || _a === void 0 ? void 0 : _a.appendChild(option);
});
...
function call() {
    if (f == 0) {
        user4.forEach(items => {
            datam === null || datam === void 0 ? void 0 : datam.forEach(items1 => {
    ...
    user4.forEach(items => {
        ...
        courseArray.forEach(items1 => {
            ...
            if (items.title1 == items1.course) {
                ...
                tr.appendChild(td4);
                tr.appendChild(td5);
                (_a = document.getElementById("table1")) === null || _a === void 0 ? void 0 : _a.appendChild(tr);
            }
        });
    });
}
// back button
(_b = document.getElementById("back")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
    window.location.href = ("../admin.html");
});
var count4 = 0;
const option = document.getElementById("courses");
...
button23.forEach(items => {
    items.addEventListener("click", () => {
        ...
        const deletecourse = (_b = (_a = items.parentElement) === null || _a === void 0 ? void 0 : _a.previousElementSibling) === null || _b === void 0 ? void 0 : _b.textContent;
        const deletename = (_f = (_e = (_d = (_c = items.parentElement) === null || _c === void 0 ? void 0 : _c.previousElementSibling) === null || _d === void 0 ? void 0 : _d.previousElementSibling) === null || _e === void 0 ? void 0 : _e.previousElementSibling) === null || _f === void 0 ? void 0 : _f.textContent;
        var data = user2;
...
button13.forEach(items => {
    items.addEventListener("click", () => {
        ...
        if (mainsub2) {
            ...
            (_g = document.getElementById('save2')) === null || _g === void 0 ? void 0 : _g.addEventListener("click", () => {
                var data1 = user2;
            ...
            (_h = document.getElementById("back2")) === null || _h === void 0 ? void 0 : _h.addEventListener("click", () => {
                window.location.reload();
            });
        }
